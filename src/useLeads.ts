...
function mapRow(row: any) {
  return {
    ...
    currentProviderSchemeType: row.current_provider_scheme_type ?? "",
    currentProviderAccountNo: row.current_provider_account_no ?? "",
    currentProviderStartDate: row.current_provider_start_date ?? null,
    currentProviderMaturityDate: row.current_provider_maturity_date ?? null,
    ...
    upfrontFeeAmount: row.upfront_fee_amount ?? null,
    upfrontFeeBasis: row.upfront_fee_basis ?? "",
    upfrontFeePaidDate: row.upfront_fee_paid_date ?? null,
...
export function useLeads() {
  ...
  const addLead = useCallback(async (input: {
    ...
    current_provider_scheme_type?: string;
    current_provider_account_no?: string;
    current_provider_start_date?: string | null;
    current_provider_maturity_date?: string | null;
    nationality?: string;
    gender?: string;
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        current_provider_scheme_type: input.current_provider_scheme_type || null,
        current_provider_account_no: input.current_provider_account_no || null,
        current_provider_start_date: input.current_provider_start_date || null,
        current_provider_maturity_date: input.current_provider_maturity_date || null,
        nationality: input.nationality || null,
        gender: input.gender || null,
        number_of_children: input.number_of_children ?? null,
        marital_status: input.marital_status || null,
        spouse_partner_name: input.spouse_partner_name || null,
        country_of_residence: input.country_of_residence || null,
        id_passport_number: input.id_passport_number || null,
